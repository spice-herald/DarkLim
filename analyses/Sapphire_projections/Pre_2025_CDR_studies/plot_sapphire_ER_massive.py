...
# Simulation
m_limit, x_limit = np.loadtxt('sapphire/results_sapphire_oi_electron_massive_001_days/HeRALD_FC_1d_1device_1fold_100mus.txt').transpose()
ax.plot(m_limit*1e3, x_limit, 'r-', lw=4, label=f'1 day, 40% PCE')
m_limit, x_limit = np.loadtxt('sapphire/results_sapphire_oi_electron_massive_010_days/HeRALD_FC_10d_1device_1fold_100mus.txt').transpose()
ax.plot(m_limit*1e3, x_limit, 'm-', lw=4, label=f'10 days, 40% PCE')
...
fig.tight_layout()
fig.savefig('sapphire_ER_massive.png')
