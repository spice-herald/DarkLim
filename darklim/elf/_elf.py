...
def get_dRdE_lambda_Al2O3_electron(mX_eV=1e8, mediator='massless', sigmae=1e-31, kcut=0, method='grid', withscreening=True, suppress_darkelf_output=False):
    """
    ...
    fun = lambda keV : np.heaviside(keV - 2 * constants.bandgap_Al203, 1) * \
            (1000 / 365.25) * \
